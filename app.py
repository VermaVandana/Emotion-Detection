...
def main():
    ...
    if choice == "Home":
        add_page_visited_details("Home", datetime.datetime.now())
        ...
        if submit_text:
            ...
            add_prediction_details(raw_text, prediction, np.max(probability), datetime.datetime.now())
        ...
        add_page_visited_details("Monitor", datetime.datetime.now())
        ...
        st.subheader("About")
        add_page_visited_details("About", datetime.datetime.now())
